-- ============================================================================
-- Migration 019: Normalize calendar transaction dates
-- ============================================================================
-- Goal:
-- 1. Keep real timestamps as timestamptz (UTC)
-- 2. Convert business calendar fields to DATE:
--    - transactions.date
--    - transactions.due_date
--    - investment_transactions.date
-- 3. Migrate existing Jakarta-centric data safely
-- 4. Recreate affected RPCs with DATE signatures/return types
-- ============================================================================
...
alter table public.transactions
  alter column date type date using ((date at time zone 'Asia/Jakarta')::date),
  alter column due_date type date using ((due_date at time zone 'Asia/Jakarta')::date);
