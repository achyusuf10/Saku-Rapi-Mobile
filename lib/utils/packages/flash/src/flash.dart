  ...
  Widget build(BuildContext context) {
    return SlideTransition(
      ...
      child: GestureDetector(
        ...
        onHorizontalDragUpdate: enableHorizontalDrag
            ? _handleHorizontalDragUpdate
            : null,
        onHorizontalDragEnd: enableHorizontalDrag
...
class _FlashBarState extends State<FlashBar>
    ...
    if (widget.icon == null && widget.primaryAction == null) {
      return [
        if (widget.indicatorColor != null)
          Container(color: widget.indicatorColor, width: 5.0),
        Expanded(
          child: Column(
            ...
            children: <Widget>[
              ...
              if (_isActionsPresent)
                ButtonTheme(
                  ...
                  child: OverflowBar(children: widget.actions!),
                ),
            ],
          ),
        ),
  ...
  Widget _getIcon(Color? iconColor) {
    ...
    if (widget.shouldIconPulse) {
      child = FadeTransition(opacity: _fadeAnimation!, child: widget.icon);
    } else {
      child = widget.icon!;
    }
    return IconTheme(
  ...
  Widget _getMessage(TextStyle textStyle) {
    return DefaultTextStyle(style: textStyle, child: widget.content);
  }
  ...
  Widget _getPrimaryAction() {
    ...
    return ButtonTheme(
      ...
      child: IconTheme(
        data: Theme.of(
          context,
        ).iconTheme.copyWith(color: buttonTheme.colorScheme?.primary),
