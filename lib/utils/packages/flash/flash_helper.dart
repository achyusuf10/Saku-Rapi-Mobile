...
class Toast extends StatefulWidget {
  ...
  const Toast({super.key, required this.child, required this.navigatorKey});
              ...
              child: FadeTransition(
                ...
                child: Flash(
                  ...
                  child: Material(
                    ...
                    elevation:
                        message.elevation ??
                        toastTheme?.elevation ??
                        defaults.elevation,
                    shadowColor:
                        message.shadowColor ??
                        toastTheme?.shadowColor ??
                        defaults.shadowColor,
                    surfaceTintColor:
                        message.surfaceTintColor ??
