...
class SakuIconMapper {
  ...
  static final List<IconSection> sections = [
    const IconSection(
      id: 'finance',
      iconNames: [
        'wallet', 'moneyBill', 'moneyBillTransfer', 'creditCard',
        'coins', 'piggyBank', 'chartLine', 'fileInvoiceDollar',
        'receipt', 'scaleBalanced', 'rightLeft',
      ],
    ),
    const IconSection(
      id: 'shopping',
      iconNames: [
        'cartShopping', 'bagShopping', 'store', 'tag', 'shirt', 'gem',
      ],
    ),
    const IconSection(
      id: 'foodDrink',
      iconNames: ['utensils', 'wineGlass', 'champagneGlasses'],
    ),
    const IconSection(
      id: 'household',
      iconNames: [
        'house', 'couch', 'lightbulb', 'key', 'lock', 'wrench',
      ],
    ),
    const IconSection(
      id: 'transport',
      iconNames: [
        'car', 'motorcycle', 'bus', 'train', 'plane',
        'gasPump', 'road', 'squareParking', 'truckFast',
      ],
    ),
    const IconSection(
      id: 'health',
      iconNames: [
        'heartPulse', 'stethoscope', 'capsules', 'hospital',
        'tooth', 'dumbbell', 'spa',
      ],
    ),
    const IconSection(
    ...
    const IconSection(
      id: 'tech',
      iconNames: [
        'laptop', 'laptopCode', 'mobile', 'tv', 'server',
        'headphones', 'camera', 'video', 'microphone', 'code', 'gamepad',
      ],
    ),
    const IconSection(
      id: 'education',
    ...
    const IconSection(
      id: 'entertainment',
      iconNames: [
        'music', 'guitar', 'film', 'trophy', 'star', 'palette', 'paintbrush',
      ],
    ),
    const IconSection(
      id: 'nature',
      iconNames: [
        'tree', 'sun', 'snowflake', 'umbrella', 'cloud', 'fire',
        'dog', 'cat', 'paw',
      ],
    ),
    const IconSection(
      id: 'social',
      iconNames: [
        'peopleGroup', 'heart', 'handHoldingHeart', 'circleUser',
        'gift', 'phone', 'envelope',
      ],
    ),
    const IconSection(
      id: 'other',
      iconNames: [
        'ellipsis', 'triangleExclamation', 'circleQuestion', 'circlePlus',
        'rocket', 'locationDot', 'compass', 'globe', 'clock', 'scissors',
      ],
    ),
  ];
  ...
  static final Map<String, List<String>> _searchTerms = {
    ...
    // Pendidikan & Karier
    'graduationCap': ['graduation', 'education', 'pendidikan', 'sekolah',
      'kuliah', 'wisuda'],
